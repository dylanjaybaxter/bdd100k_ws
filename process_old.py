...
def init_parser():
    ...
    parser.add_argument('--lbls', type=str, default=label_path_d, help='Path to pytorch')
    parser.add_argument('--vids', type=str, default=vid_path_d, help='Path to video folders')
    parser.add_argument('--dest', type=str, default=dest_path_d, help='Path to save processed data')
